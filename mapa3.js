...
// Vista inicial para Alemania / Bundesliga
const bundesligaBounds = L.latLngBounds(
  [47.0, 5.5],   // suroeste
  [55.3, 15.5]   // noreste
);
...
function setInitialBundesligaView() {
  map.fitBounds(bundesligaBounds, {
    padding: [20, 20]
  });
}
