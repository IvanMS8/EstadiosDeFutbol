...
// Vista inicial para Reino Unido / Premier League
const premierBounds = L.latLngBounds(
  [49.8, -8.8],
  [55.9, 2.2]
);
...
function setInitialPremierView() {
  map.fitBounds(premierBounds, {
    padding: [20, 20]
  });
}
...
function focusStadium(button) {
  ...
  // Transición suave entre estadios
  ...
  // Respaldo por si moveend tarda o falla
